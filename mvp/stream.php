...
$path = rtrim(UPLOAD_VIDEO_DIR, '/') . '/' . $video['filename'];
if (!is_file($path)) {
    http_response_code(404);
    die('Video file missing on disk.');
}
...
header('Cache-Control: private, no-store'); // never cached as a permanent public asset
