...
class SharePage {
  public static function render(string $token){
    ...
    echo "<!doctype html><html><head><meta charset='utf-8'><meta name='viewport' content='width=device-width,initial-scale=1'><title>$title</title><style>body{margin:0;background:#000;color:#eee;font-family:system-ui} .wrap{position:relative;aspect-ratio:16/9;max-width:1100px;margin:0 auto;background:#000} iframe{width:100%;height:100%;border:0} .wm{position:absolute;bottom:16px;right:16px;background:rgba(0,0,0,.35);padding:5px 10px;border-radius:6px;font-size:12px;opacity:.5} header{padding:12px 16px;background:#0f0f17;display:flex;justify-content:space-between;align-items:center}</style></head><body>";
