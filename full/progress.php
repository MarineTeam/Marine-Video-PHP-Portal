...
$forceCompleted = !empty($input['completed']);
...
$completed = $forceCompleted || ($duration > 0 && $position / $duration >= 0.95) ? 1 : 0;
...
$prev = $prevStmt->fetch();
$delta = min(60, $prev ? max(0, $position - (int)$prev['position_seconds']) : $position);
