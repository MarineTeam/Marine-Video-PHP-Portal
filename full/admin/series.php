      ...
      <tr>
        ...
        <td>
          ...
          <details style="display:inline-block">
            <summary style="display:inline;cursor:pointer;color:var(--accent1);">Share</summary>
            <form method="post" action="shares.php" class="share-form">
              <?= csrf_field() ?><input type="hidden" name="action" value="create">
              <input type="hidden" name="content_type" value="series"><input type="hidden" name="content_id" value="<?= (int)$s['id'] ?>">
              <input type="email" name="recipient_email" placeholder="recipient@email.com" required>
              <input type="number" name="hours" value="72" min="1" max="720"> hrs
              <?php if (resend_is_configured()): ?><label><input type="checkbox" name="send_email" value="1" checked> Email it</label><?php endif; ?>
